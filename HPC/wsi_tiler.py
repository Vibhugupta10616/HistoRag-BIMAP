...
Self-contained copy for HPC use — no dependency on the histoRAG package.
Only discard patches that are essentially pure white (min_tissue_frac=0.01).
"""
...
class Tiler:
    ...
    min_tissue_frac=0.01 means only pure-white glass patches are discarded.
    Any patch with even a trace of tissue colour is kept.
    """
