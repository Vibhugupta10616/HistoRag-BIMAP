"""
H1 Experiment 02 — K-means k=8 Over-cluster + Assign (Q2)

Pipeline:
    1. Pass 1: proportional subsample -> fit KMeans k=8
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="H1 exp02 K-means k=8 over-cluster + assign.")
