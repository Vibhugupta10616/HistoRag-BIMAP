...
def run(
    ...
    print(f"\n[H1 exp01] encoder={encoder} | mode={'full-MiniBatch' if full else 'subsample-KMeans'}")
    ...
    if full:
        ...
        print(f"\n[H1 exp01] Loading ALL embeddings for encoder={encoder}...")
        ...
        print(f"[H1 exp01] {manifest['slide_id'].nunique()} slides | "
        ...
        print(f"\n[H1 exp01] Pre-scan — counting patches per slide...")
